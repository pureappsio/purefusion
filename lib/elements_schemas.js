...
// Half width pic element
halfWidthElementSchema = new SimpleSchema({
...
halfWidthElementSchema.extend(baseElementSchema);
...
// Portfolio detail element
portfolioDetailElementSchema = new SimpleSchema({
...
portfolioDetailElementSchema.extend(baseElementSchema);

// Feature box button element
featButtonElementSchema = new SimpleSchema({
...
featButtonElementSchema.extend(baseElementSchema);
...
Elements.attachSchema(portfolioElementSchema, { selector: { type: 'portfolio' } });
Elements.attachSchema(portfolioDetailElementSchema, { selector: { type: 'portfoliodetail' } });
...
Elements.attachSchema(featButtonElementSchema, { selector: { type: 'featureboxbutton' } });
Elements.attachSchema(halfWidthElementSchema, { selector: { type: 'imagehalf' } });
