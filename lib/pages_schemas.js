...
Pages.attachSchema(basePageSchema, { selector: { type: 'tripwire' } });
Pages.attachSchema(leadgenSchema, { selector: { type: 'leadgen' } });
Pages.attachSchema(basePageSchema, { selector: { type: 'thankyou' } });
Pages.attachSchema(basePageSchema, { selector: { type: 'closed' } });