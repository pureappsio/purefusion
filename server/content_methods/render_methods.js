        ...
        Template.header.helpers({
            ...
            featuredPicture: function() {
                ...
                if (parameters.featuredPicture) {
                    ...
                    if (Images.findOne(parameters.featuredPicture)) {
    ...
    renderAllPosts: function(parameters) {
        ...
        Template.allPosts.helpers({
            ...
            postImage: function(featuredPicture) {
                ...
                if (Images.findOne(featuredPicture)) {
                    ...
                    if (post.cached == true && !(query.origin)) {
                        ...
                        if (post.type) {
                            ...
                            if (post.category == 'recipe') {
                                ...
                                // Get theme
                                if (brand.affiliateTheme) {
                                    var selectedTheme = brand.affiliateTheme;
                                } else {
                        ...
                        if (post.type) {
                            ...
                            if (query.origin) {
                                Pages.update({ url: postUrl, brandId: parameters.brandId }, { $set: { cached: false, html: rawHtml } }, { selector: { type: post.type } })
                            } else {
                                Pages.update({ url: postUrl, brandId: parameters.brandId }, { $set: { cached: true, html: rawHtml } }, { selector: { type: post.type } })
                            }
